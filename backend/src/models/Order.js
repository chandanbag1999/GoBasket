...
const orderSchema = new mongoose.Schema(
  {
    ...
    payment: {
      ...
      paymentDetails: {
        ...
        wallet: String, // Wallet provider
        upi: {
          vpa: String, // UPI VPA used
        },
        card: {
...
orderSchema.methods.cancel = function (reason, cancelledBy) {
  ...
  this.cancellation = {
    ...
    refundStatus:
      this.payment.status === "completed" ? "pending" : "not_applicable",
  };
...
orderSchema.statics.getCustomerOrders = function (
  customerId,
  page = 1,
  limit = 10
) {
...
orderSchema.statics.getRestaurantOrders = function (
  restaurantId,
  status = null,
  page = 1,
  limit = 20
...
orderSchema.statics.getDeliveryPersonnelOrders = function (
  deliveryPersonnelId,
  status = null
) {
