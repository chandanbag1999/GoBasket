...
const validationRules = {
  ...
  resetPassword: [
    ...
    param("token").isLength({ min: 10 }).withMessage("Invalid reset token"),
  ...
  // Payment validation
  createPaymentOrder: [
    body("orderId").matches(patterns.objectId).withMessage("Invalid order ID"),
  ...
  paymentFailure: [
    ...
    body("error.description")
      .optional()
      .isLength({ max: 200 })
      .withMessage("Error description cannot exceed 200 characters"),
